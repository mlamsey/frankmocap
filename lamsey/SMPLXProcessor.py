...
smplx_path = os.path.expanduser("~") + "/Development" + "/HRL/assistive-gym/assistive_gym/envs/assets/smpl_models"
example_pkl_path = os.path.expanduser("~") + "/Development" + "/HRL/SAMP/pkl/armchair001_stageII.pkl"
